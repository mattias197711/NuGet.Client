...
namespace NuGet.SolutionRestoreManager {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to NuGet package couldn&apos;t be restored because consent has not been granted.To give consent, open the Visual Studio Options dialog, click on the Package Manager node and check &apos;Allow NuGet to download missing packages during build.&apos; You can also give consent by setting the environment variable &apos;EnableNuGetPackageRestore&apos; to &apos;true&apos;..
        /// </summary>
